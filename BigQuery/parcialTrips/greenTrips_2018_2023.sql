...
AS
SELECT pickup_datetime, dropoff_datetime, passenger_count, trip_distance, payment_type, pickup_location_id, dropoff_location_id, 
    CAST(total_amount AS NUMERIC) AS total_amount, CAST(tip_amount AS NUMERIC) AS tip_amount
